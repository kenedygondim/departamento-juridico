...
//Bibliotecas 
#include <stdio.h> //é usada para operações de entrada e saída em C, como leitura e escrita de dados
#include <time.h> //é usada para manipulação de data e hora em C
