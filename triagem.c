...
void gerarRelatorio(triagem* atendimento)
{
	...
	if (atendimento->recebeBeneficio) printf("Valor do Benefício         : %f\n", atendimento->valorBeneficio);
