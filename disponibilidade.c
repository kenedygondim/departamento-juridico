...
void adicionarDisponibilidade() {
	...
	// Validação do formato, enquanto não for R ou P, pede para inserir novamente
	do {
...
void mostrarRelatorioAdvDis() {
	...
	//percorre o array de disponibilidades e verifica se a disponibilidade é do dia da semana informado + 1
...
Disponibilidade obterDisponibilidadeEspecifica(int oab, int diaSemana)
{
	...
	//percorre o array de disponibilidades e verifica se a disponibilidade é do advogado com a OAB e do dia da semana informados
	for (int i = 0; i < count; i++)
	{
